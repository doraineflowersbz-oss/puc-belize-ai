...
# --- MULTI-VOLTAGE MATHEMATICS BACKEND (0% AI INTERFERENCE) ---
def run_universal_voltage_engine(raw_data, phase_config, volt_config):
    ...
    # Complete Overcurrent Device Spectrum - NEC Section 240.6(A)
    ...
    # Sizing minimum branched circuit counts mathematically
    ...
    # --- PHASE VECTOR LINE CALCULATION LOGIC ---
    ...
    # Conductor run layout arrays strictly following NEC Table 310.16 (75°C Copper THHN)
...
def compile_universal_pdf(phase_config, volt_config, raw_data, calcs, eng, client, loc):
    ...
    t_meta = Table(meta_table, colWidths=[180, 340])
    ...
    t_load = Table(load_table, colWidths=[180, 180, 160])
