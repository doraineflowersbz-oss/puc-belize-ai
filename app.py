...
# ReportLab layout engine parameters for clean multi-page document creation
from reportlab.lib.pagesizes import letter
from reportlab.platypus import SimpleDocTemplate, Paragraph, Spacer, Table, TableStyle, PageBreak
from reportlab.lib.styles import getSamimport os
import streamlit as st
from google import generativeai as genai
from PIL import Image
import json
...
def compile_universal_pdf(phase_config, volt_config, raw_data, calcs, eng, client, loc):
    ...
    t_load = Table(load_table, colWidths=[180, 170, 170])
...
def compile_universal_pdf(phase_config, volt_config, raw_data, calcs, eng, client, loc):
    ...
    t_load = Table(load_table, colWidths=[200, 160, 160])
    t_load.setStyle(TableStyle([('BACKGROUND', (0,0), (-1,0), colors.HexColor('#EDF2F7')), ('GRID', (0,0), (-1,-1), 0.5, colors.grey), ('PADDING', (0,0), (-1,-1), 5)]))
    story.append(t_load)
